          ...
          <form className='p-6 flex flex-col gap-10'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <div className='flex items-center'>
                ...
                <i className={`bi ${show ? "bi-eye" : "bi-eye-slash"} text-xl relative right-[35px] cursor-pointer`}onClick={showPass}></i>
              </div>
            </div>
            {/*Submit Button*/}
            <div className='text-center w-[97%] flex flex-col gap-3'>
